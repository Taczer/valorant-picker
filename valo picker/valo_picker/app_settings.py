...
def settings_from_dict(raw: dict[str, Any]) -> AppSettings:
    ...
    return AppSettings(refresh_seconds=refresh, default_start_mode=start_mode, language=language, profile=profile)
...
def with_language(settings: AppSettings, language: str) -> AppSettings:
    return AppSettings(
        refresh_seconds=settings.refresh_seconds,
        default_start_mode=settings.default_start_mode,
