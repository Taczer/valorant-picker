...
3. zostaw program uruchomiony albo wybierz `3. Refresh Now`.
...
4. jeśli komunikat dotyczy `pregame` i nadal jesteś w Agent Select, wybierz `3. Refresh Now`, wejdź ponownie w lobby albo zrestartuj Valoranta.
